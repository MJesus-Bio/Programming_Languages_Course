...
(define tests
  (test-suite
   ...
   (check-equal? (mupllist->racketlist (apair (var "a") (apair (int 4) (aunit)))) (list (var "a") (int 4)) "racketlist->mupllist test")

   ;; tests if ifgreater returns (int 2)
   (check-equal? (eval-exp (ifgreater (int 3) (int 4) (int 3) (int 2))) (int 2) "ifgreater test")
   (check-equal? (eval-exp (ifgreater (int 4) (int 3) (int 3) (int 2))) (int 3) "ifgreater test")
   (check-equal? (eval-exp (ifgreater (int 3) (add (int 3) (int 4)) (int 3) (int 2))) (int 2) "ifgreater test")
   ...
   (check-equal? (eval-exp (call (closure '() (fun "add" "x" (add (var "x") (int 7)))) (int 1))) (int 8) "call test")
   (check-equal? (eval-exp (call (closure '() (fun "sum-rest" "x" (ifgreater (var "x")
                                                                             (int 1)
                                                                             (add (var "x") (call (var "sum-rest") (add (var "x") (int -1))))
                                                                             (int 1)))) (int 5))) (int 15) "call test")
   ...
   (check-equal? (eval-exp (fst (eval-exp (snd (apair (int 1) (apair (int 2) (int 3))))))) (int 2) "snd test")
   ...
   (check-equal? (eval-exp (ifaunit (int 1) (int 2) (add (int 3) (int 4)))) (int 7) "ifaunit test")
   
   ;; mlet* test
   (check-equal? (eval-exp (mlet* (list (cons "x" (int 10))) (var "x"))) (int 10) "mlet* test")
   (check-equal? (eval-exp (mlet* (list (cons "x" (int 10)) (cons "x" (add (var "x") (var "x")))) (var "x"))) (int 20) "mlet* test")
